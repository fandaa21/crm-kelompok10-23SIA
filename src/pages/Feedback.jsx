// Ganti seluruh isi file Feedback.jsx Anda dengan ini
...
const initialReviews = [
    { id: 1, name: "John Doe", rating: 4, comment: "Kamar sangat nyaman, namun kebersihannya kurang.", category: "Kebersihan", date: "2025-06-01" },
    { id: 2, name: "Jane Smith", rating: 5, comment: "Pelayanan luar biasa, saya merasa sangat dihargai!", category: "Layanan", date: "2025-06-02" },
    { id: 3, name: "Alice Brown", rating: 3, comment: "Fasilitas oke, tetapi AC-nya kurang dingin.", category: "Fasilitas", date: "2025-06-03" },
    { id: 4, name: "Robert Wilson", rating: 5, comment: "Semuanya sempurna, akan kembali lagi!", category: "Layanan", date: "2025-06-04" },
];
...
export default function FeedbackManagement() {
    ...
    const csvHeaders = [
        ...
        { label: "Rating", key: "rating" }, { label: "Comment", key: "comment" },
        { label: "Category", key: "category" }, { label: "Date", key: "date" },
    ];
    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <CSVLink data={reviews} headers={csvHeaders} filename="customer_feedback.csv" className="flex items-center gap-2 px-4 py-2 text-sm border rounded-lg hover:bg-gray-100">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="text-gray-800">
                            {reviews.map((review) => (
                                // 'border-t' sudah dihapus dari sini
                                <tr key={review.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-gray-600">{review.category}</td>
                ...
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                    <div className="bg-white p-8 rounded-xl w-full max-w-lg shadow-2xl">
                        ...
                        <div className="mt-4 p-4 bg-gray-50 rounded-lg border">
                            <p className="font-semibold">{selectedReview.name} - <span className="text-gray-500 font-normal">{selectedReview.category}</span></p>
                        ...
                        <form onSubmit={handleResponseSubmit} className="mt-4 space-y-4">
                            <div>
                                ...
                                <textarea id="response" value={responseText} onChange={(e) => setResponseText(e.target.value)} className="w-full p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" rows="4" placeholder="Tulis tanggapan Anda di sini..." required />
                            </div>
